<template>
  <div class="pb-5">
    ...
    <div class="container g-hero mt-5">
      <div class="row">
        <div class="col-md-8">
          ...
          <p class="g-hero-tag mb-5">
            The apprentice program offers you the opportunity to learn software
            development by contributing to open source apps as an engineer,
            designer, or product manager with guidance and structure from a
            mentor
          </p>
    ...
    <div class="container">
      ...
      <p class="g-hero-tag">
        Grey Software developed the apprentice program as an internship
        alternative to student software developers. You'll collaborate on open
        source software with structure and guidance from a mentor, and walk away
        with valuable skills and a public demonstration of your work that you
        can take anywhere.
      </p>
      <div class="g-hero-cta-container mb-3">
        <a href="/projects">
          <b-button size="lg" class="mr-4 g-btn-cta"
  ...
  data() {
    return {
      ...
      testimonials: [
        ...
        {
          imgSrc: 'https://avatars1.githubusercontent.com/u/60441990?s=460&v=4',
          name: 'Baichen',
          desc:
