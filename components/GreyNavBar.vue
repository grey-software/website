<template>
  <div class="container nav g-header pt-4 flex align-items-center">
    <input
      type="checkbox"
      id="nav-check"
      v-model="checked"
    ...
    <div class="nav-header">
      ...
      >
        <img
          ...
          src="../assets/logo.png"
        />
        <span class="logo-text">Grey Software</span>
      </nuxt-link>
    </div>
    <div class="nav-btn">
      <label for="nav-check">
    ...
    <div class="nav-links">
      ...
      <a
        ...
        class="btn-github-sponsors mx-3 my-3"
      ><svg
          class="icon-github-sponsors"
          viewBox="0 0 16 16"
          version="1.1"
          width="16"
          height="16"
